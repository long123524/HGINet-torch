...
class Decoder(nn.Module):
    """Decoder block"""
    def __init__(self, label_nbr, depths):
        """Init Decoder fields."""
...
class HRSCD3(nn.Module):
    def __init__(self, input_nbr, label_nbr, wsl = False):
        ...
        if wsl:
            self.CDDecoder = Decoder(2, self.CDEncoder.depths)
        else:
            self.CDDecoder = Decoder(1, self.CDEncoder.depths)
